...
describe.only('<Catalog>', function() {
  ...
  describe('basics', function() {
    ...
    it('should subscribe to app.activeTabChanged', async function() {
      ...
      const { instance } = await createCatalog({ subscribe });
  ...
  describe('apply element template', function() {
    ...
    beforeEach(async function() {
      ...
      ({ instance, wrapper } = await createCatalog({ triggerAction: triggerActionSpy }));
    });
  ...
  describe('modal', function() {
    ...
    beforeEach(async function() {
      ({ instance, wrapper } = await createCatalog());
    });
...
async function createCatalog(props = {}) {
  const defaultProps = {
    config: {},
    displayNotification() {},
    subscribe() {},
  ...
  const wrapper = shallow(<Catalog { ...{ ...defaultProps, ...props } } />);
